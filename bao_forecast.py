...
def IndividualBAOError(z_min, z_max, n_gal, sigma_z, bias, area):
    ...
    # -----------------------------------------------------
    # RSD term with photo-z smearing
    # -----------------------------------------------------
    ...
    # -----------------------------------------------------
    # Extra BAO damping from photo-z smearing
    # -----------------------------------------------------
    ...
    prefactor = (amp_BAO**2 * volume / 2.0) # in (Mpc/h)^3. The factor 1/2 is not in eq. 26 of https://arxiv.org/pdf/astro-ph/0701079, but it is in eq. 25 (I think they forgot it in 26)
